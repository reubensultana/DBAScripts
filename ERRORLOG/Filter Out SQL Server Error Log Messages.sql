...
UNION ALL SELECT N'State information for database %'
...
UNION ALL SELECT N'The target database, %, is participating in an availability group and is currently not accessible for queries%'
